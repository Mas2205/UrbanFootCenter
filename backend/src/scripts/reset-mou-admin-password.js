...
const adminEmail = 'mou_admin_urban@ex.com';

// Nouveau mot de passe souhaité
const newPassword = 'MouAdmin2025!'; // Mot de passe fort et mémorisable

async function resetMouAdminPassword() {
  try {
