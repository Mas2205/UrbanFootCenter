...
async function createTestDataWithUUIDs() {
  try {
    console.log('=== CRÉATION DE DONNÉES DE TEST AVEC UUIDS ===');
    ...
    // Créer des réservations de test avec de vrais UUIDs
    ...
    // Créer des paiements de test avec de vrais UUIDs
    ...
    console.log('\n🎉 Données de test créées avec succès ! Vous pouvez maintenant tester l\'interface des paiements.');
