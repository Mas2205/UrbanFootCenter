...
async function populateTestPayments() {
  try {
    ...
    // Générer des données de test pour les paiements
    const testPayments = [
      {
    ...
    for (const payment of testPayments) {
      const insertQuery = `
        INSERT INTO payments (id, reservation_id, amount, payment_method, payment_status, transaction_id, payment_date, receipt_url, payment_details, created_at, updated_at)
