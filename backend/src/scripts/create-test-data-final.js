...
async function createTestDataFinal() {
  try {
    console.log('=== CRÉATION DE DONNÉES DE TEST FINALES ===');
    ...
    // Créer des réservations de test avec la structure correcte
    ...
    // Créer des paiements de test avec la structure correcte
    ...
    const testPayments = [
      ...
      {
        id: 'test-payment-4',
        reservation_id: 'test-reservation-3',
        amount: 20000,
        payment_method: 'wave',
        payment_status: 'pending',
