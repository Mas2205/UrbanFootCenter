              ...
              <CardContent>
                ...
                <Box sx={{ mt: 2 }}>
                  ...
                  {field.image_url ? (
                    <Box 
                      component="img"
                      src={field.image_url.startsWith('http') ? field.image_url : `${API_BASE_URL.replace('/api', '')}${field.image_url}`}
                      alt={field.name}
                      crossOrigin="anonymous"
                      onError={(e) => {
                        console.error('Erreur de chargement image:', field.image_url);
                        const fullUrl = field.image_url?.startsWith('http') ? field.image_url : `${API_BASE_URL.replace('/api', '')}${field.image_url}`;
